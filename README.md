...
[![Build status](https://github.com/ChieloNewctle/krun-debian/actions/workflows/build-deb.yml/badge.svg)](https://github.com/ChieloNewctle/krun-debian/actions)
...
`deb.sh` is meant to run in `rust:1-slim-trixie` (needs `rustc`/`cargo` for
libkrun, and Debian tooling for `.deb`).
